...
Karin: this is ok as last paragraph, but the tematres part is missing: Data
discovery.
...
relevant data but also could be used in the process of integrating the data
for analysis. But ontology engineering and maintenance can be quite complex
