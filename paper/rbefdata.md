...
of them are widely spread or accepted throughout ecology.  The acceptance can
...
of concepts with the potential to improve the scientific progress in the long
run. 
...
## Linear Hypotheses:
##            Estimate Std. Error z value Pr(>|z|)    
## 2 - 1 == 0    1.053      0.293    3.59  0.00074 ***
## 4 - 1 == 0    0.865      0.497    1.74  0.18393    
