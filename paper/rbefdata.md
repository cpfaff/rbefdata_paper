...
development tools that help with the preservation, the exploration as well as
with the reuse of data. Many tools and concepts available provide solutions to
different parts of the life cycle of data. However not all of them are widely
...
data provenance as new ways to promote the discussion of ideas and the
...
highly valuable concepts with the potential to improve the scientific progress. 
