...
into widely accepted and commonly used software. A trending concept to
streamline the processing of is workflows. They enable the access to data and
metadata, the manipulation and analysis of data as well as the preservation of
valuable data products. The Kepler (cite xxx) and the Pegasus (cite xxx)
software are only two examples of software that follows this concept.
