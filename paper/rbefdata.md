...
been developed that provide solutions to parts of the life cycle of data.
However not all of them are widely spread or accepted throughout ecology. The
situation could be improved by the tight integration of data management
...
concepts with the potential to improve the scientific progress. 
